...
public class GPProgram
  ...
  private String m_additionalFitnessInfo;
  
  private boolean m_reevalFitness;
  ...
  /**
   * Additional Information about the fitness of the specific program useful for logging.
   * @author Swen E. Gaudl
   * @since 3.6.2
   */
  public String getAdditionalFitnessInfo(){
    return m_additionalFitnessInfo;
  }
  
  /**
   * Setting additional Information about the fitness of the specific program useful for logging.
   * @author Swen E. Gaudl
   * @since 3.6.2
   */
  public void setAdditionalFitnessInfo(String info){
    m_additionalFitnessInfo=info;
  }
   ...
   * @since 3.6.2
   */
  public void setReEvaluateFitness(boolean reeval){
